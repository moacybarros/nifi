...
public class GetCouchbaseKey extends AbstractCouchbaseProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        String docId = null;
        if (!isEmpty(context.getProperty(DOC_ID).getValue())) {
        ...
        try {
            ...
            // A function to write a String representation of document into the original FlowFile attribute.
            Function<Document<?>, String> docToString = null;
            ...
            switch (documentType) {
                case Json: {
                    ...
                    if (document != null) {
                        ...
                        docToString = d -> document.content();
                ...
                case Binary: {
                    ...
                    if (document != null) {
                        ...
                        docToString = d -> {
                            // Map the binary content to String with best effort.
                            final ByteBuf byteBuf = document.content();
            ...
            if (doc == null) {
                logger.warn("Document {} was not found in {}; routing {} to failure", new Object[] {docId, getTransitUrl(context, docId), inFile});
            ...
            if (putToAttribute) {
                outFile = inFile;
                updatedAttrs.put(putTargetAttr, docToString.apply(doc));
            } else {
